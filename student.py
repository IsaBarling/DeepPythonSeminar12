...
if __name__ == '__main__':
    student = Student()
    student.first_name = 'Isa'
    student.last_name = 'Barling'
    student.grades = {'История': (5, 4, 4), 'География': (4, 3, 5), 'Английский': (5, 5, 5)}
    student.tests = {'Музыка': (80, 73, 95), 'Физкультура': (70, 85, 90)}
    print(student)
